...
def main():
    ...
    with open('/home/gaetano/Desktop/blender/action.vdata', encoding='utf-8-sig') as file:
    ...
    bpy.ops.import_anim.bvh(filepath="/home/gaetano/Dropbox/Senior_Project/mocap_dataset/BVH_Conversion/cmu_bvh/" + bvh_load_path)
